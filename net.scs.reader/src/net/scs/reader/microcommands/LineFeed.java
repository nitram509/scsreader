 ...
 */
public class LineFeed extends PrinterMicroCommandAdapter {

	public final static byte OPCODE = 0x25;

	public LineFeed(IScsDataProvider dataProvider) {
		super(dataProvider);
	}

	@Override
	public void print(IVirtualPrinter printer) {
		final int pos = printer.getHeadDirH();
		printer.newLine();
		printer.setHeadDirH(pos);
	}
}
