 ...
 * Name        : Carrige return
 */
public class CarrigeReturn extends PrinterMicroCommandAdapter {

	public final static byte OPCODE = 0x0D;

	public CarrigeReturn(IScsDataProvider dataProvider) {
		super(dataProvider);
	}

	@Override
	public void print(IVirtualPrinter printer) {
		printer.carrigeReturn();
	}
}
